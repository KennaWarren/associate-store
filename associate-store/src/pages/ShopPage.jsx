  ...
  return (
    <div>
      ...
      <div style={{
        ...
        padding:"60px 24px", textAlign:"center", borderBottom:"3px solid #A22325",
      }}>
        <p style={{ fontSize:11, color:"#A22325", letterSpacing:"0.2em", textTransform:"uppercase", fontWeight:700, marginBottom:12 }}>For Associates Only</p>
        <h1 style={{ fontFamily:"'Georgia', serif", fontSize:"clamp(2rem, 5vw, 3.2rem)", color:"#fff", fontWeight:700, margin:"0 0 16px", letterSpacing:"-0.01em" }}>
          The Associate Store
        </h1>
        ...
        <div style={{ maxWidth:360, margin:"0 auto" }}>
          <input type="text" placeholder="Search products..." value={search} onChange={e => setSearch(e.target.value)}
            style={{ width:"100%", padding:"12px 18px", borderRadius:8, border:"1.5px solid #333", background:"#1a1a1a", color:"#fff", fontSize:14, outline:"none", boxSizing:"border-box" }} />
        </div>
      </div>
