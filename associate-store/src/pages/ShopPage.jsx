  ...
  return (
    <div style={{ background: "#F7F7F7", minHeight: "100vh" }}>
      ...
      <div style={{
        ...
        borderBottom: "1px solid #EAEAEA", position: "relative", overflow: "hidden",
      }}>
        ...
        <div style={{ position:"relative", maxWidth:600, margin:"0 auto" }}>
          <span style={{ display:"inline-block", background:"#FFF0F0", border:"1px solid rgba(162,35,37,0.2)", color:"#A22325", fontSize:11, fontWeight:700, letterSpacing:"0.18em", textTransform:"uppercase", padding:"6px 16px", borderRadius:20, marginBottom:24 }}>Associates Only</span>
          <h1 style={{ fontFamily:"'Georgia', serif", fontSize:"clamp(2.4rem, 5vw, 3.8rem)", color:"#1a1a1a", fontWeight:700, margin:"0 0 18px", letterSpacing:"-0.02em", lineHeight:1.1 }}>The Associate Store</h1>
          <p style={{ color:"#777", fontSize:17, maxWidth:420, margin:"0 auto 36px", lineHeight:1.7 }}>Exclusive company merchandise for our team. Quality goods at member-only pricing.</p>
          <div style={{ maxWidth:400, margin:"0 auto", position:"relative" }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#bbb" strokeWidth="2" style={{ position:"absolute", left:16, top:"50%", transform:"translateY(-50%)", pointerEvents:"none" }}>
              <circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/>
            </svg>
            <input type="text" placeholder="Search products..." value={search} onChange={e => setSearch(e.target.value)}
              style={{ width:"100%", padding:"14px 16px 14px 46px", borderRadius:12, border:"1.5px solid #EAEAEA", background:"#fff", color:"#1a1a1a", fontSize:14, outline:"none", boxSizing:"border-box", boxShadow:"0 2px 12px rgba(0,0,0,0.06)" }}
      ...
      <div style={{ maxWidth:1200, margin:"0 auto", padding:"40px 32px 80px" }}>
        {productsLoading ? (
          <div style={{ textAlign:"center", padding:"80px 0" }}>
            ...
            <p style={{ color:"#bbb", fontSize:15 }}>Loading products…</p>
          </div>
        ) : productsError ? (
          <div style={{ textAlign:"center", padding:"80px 0" }}>
            <p style={{ color:"#A22325", fontSize:15 }}>Could not load products. Please refresh the page.</p>
          </div>
        ) : (
          <>
