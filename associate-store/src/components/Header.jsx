      ...
      <div style={{
        ...
        <button onClick={() => setPage("shop")} style={{
          ...
          <div style={{
            ...
            boxShadow: "0 2px 8px rgba(162,35,37,0.3)",
          }}>
            <span style={{ color: "#fff", fontSize: 16, fontWeight: 800, fontFamily: "Georgia, serif" }}>A</span>
          </div>
          <div style={{ textAlign: "left" }}>
            <div style={{ fontSize: 14, fontWeight: 700, color: "#1a1a1a", letterSpacing: "0.04em" }}>
              Rogers & Hollands | Ashcroft & Oak
            </div>
            <div style={{ fontSize: 10, color: "#A22325", letterSpacing: "0.16em", textTransform: "uppercase", marginTop: 1, fontWeight: 600 }}>
              Associate Store
            </div>
          </div>
        </button>
        ...
        <nav style={{ display: "flex", gap: 4, alignItems: "center" }}>
          ...
          <button onClick={() => setPage("cart")} style={{
            ...
            border: "1.5px solid",
            borderColor: page === "cart" ? "#A22325" : "#EAEAEA",
